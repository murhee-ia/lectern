...
test("form rejects submission without a completed Turnstile challenge", async ({ page }) => {
...
test("disposable-email domain is rejected inline before any signup request", async ({ page }) => {
